...
Begin VB.Form Form7 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Label Label4 
         ...
         Caption         =   "Money Successfully Deposited"
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   27.75
            Charset         =   0
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Label Label2 
         AutoSize        =   -1  'True
         BackStyle       =   0  'Transparent
         Caption         =   "Amount to be Deposited (max 50000)"
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   9.75
            Charset         =   0
...
Private Sub cmdSubmit_Click()
    ...
    If IsNumeric(txtDep.Text) And Val(txtDep.Text) <= 50000 Then
        Dim i As Long
        i = amt + Val(txtDep.Text)
